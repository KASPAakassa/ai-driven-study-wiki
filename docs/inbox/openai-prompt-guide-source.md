# 原始资料:重磅!OpenAI 官方 Prompt 指南发布

> 来源:微信公众号「Datawhale」(作者:Eric Provencher,OpenAI;Datawhale 翻译整理)
> 原文链接:https://mp.weixin.qq.com/s/lSvGH3nCK9oWf8wOyeCTGA;官方指南:https://developers.openai.com/api/docs/guides/prompt-guidance-gpt-5p6
> 抓取日期:2026-08-09;状态:已整理为正式文章 docs/07-agent-coding/experience/openai-prompt-guide.md(给 Coding Agent 的 System Prompt 做减法)

---

Datawhale干货 
作者：Eric Provencher，OpenAI团队
