> 来源:GitHub 仓库 HKUDS/AutoAgent(README + arXiv 2502.05957 摘要)
> 链接:https://github.com/HKUDS/AutoAgent | 论文 https://arxiv.org/abs/2502.05957
> 抓取日期:2026-08-10;stars 9730, forks 1357, MIT, Python
...
```bash
auto main # default model is claude-3-5-sonnet-20