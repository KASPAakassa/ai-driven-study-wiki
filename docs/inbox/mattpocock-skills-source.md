# 原始资料:mattpocock/skills 仓库 README 快照

> 来源:https://github.com/mattpocock/skills(抓取日期:2026-08-09,内容随仓库更新而变化)
> 状态:已整理为正式文章 docs/07-agent-coding/skills/mattpocock-skills.md
