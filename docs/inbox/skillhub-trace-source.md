# 原始资料:10万+Skill 背后:腾讯SkillHub如何帮用户找到真正好用的那20%

> 来源:微信公众号「腾讯程序员」《10万+Skill 背后:腾讯SkillHub如何帮用户找到真正好用的那20%》(作者:赵秀雯);原文链接:https://mp.weixin.qq.com/s/rSVXMwOMLSEhl7gC5KdBCg
> 抓取日期:2026-08-09;状态:已整理为 docs/07-agent-coding/skills/skillhub-trace-evaluation.md
> 性质:SkillHub 平台级 Skill 质量治理与分发实践:TRACE 五维评测体系、云端隔离试运行、榜单/标签组织、find skill 面向 Agent 的发现
...
TRACE 维度评测子维度主要回答的问题Trust（可信任度）
国内适配性、安全性扫描
...
层次回答的问题形成的证据TRACE 测评这个 Skill 看起来是否可信、规范、可理解
结构、依赖、说明和静态扫描结果
