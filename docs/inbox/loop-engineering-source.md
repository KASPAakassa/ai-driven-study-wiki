# 原始资料:中金:基于 Loop Engineering 的自动化因子发现引擎

> 来源:中金研究《大模型系列(7):基于 Loop Engineering 的自动化因子发现引擎》(郑文才、周萧潇、刘均伟)
> 原文链接:https://mp.weixin.qq.com/s/hrKdYATh_9rdASVAdjGymg
> 抓取日期:2026-08-09;状态:已整理为正式文章 docs/07-agent-coding/experience/loop-engineering.md
